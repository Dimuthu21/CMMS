...
if (document.getElementById("_dm-settingsContainer")) {
   ...
   conf.slideNavRadio.checked =           body.classList.contains("mn--slide");
   ...
   // Safely obtain bootstrap link href and assetsPath (avoid null access)
   const bsLink = getLinkTag("bootstrap.");
   const defaultBsUrl = (bsLink && typeof bsLink.getAttribute === 'function') ? bsLink.getAttribute("href") : "";
   const assetsPathMatch = defaultBsUrl ? defaultBsUrl.match(/^.*?assets/g) : null;
   const assetsPath = assetsPathMatch ? assetsPathMatch[0] : "";
